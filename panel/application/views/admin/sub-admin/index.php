        ...
        <div class="left">
           ...
           <br>
            <small class="pull-left">You can see all registered <?=$title;?> here</small>
             ...
             <div class="right">
                <a href="<?php echo base_url('admin');?>/add-sub-admin" class="btn btn-sm btn-success btn-add-new">
                    ...
                    <table class="table table-bordered table-striped dataTable" id="cs_datatable" role="grid"
                        ...
                        <?php foreach ($users as $user): ?>
                            <tr>
                                ...
                                <td>
                                    <!-- form delete user -->
                                    <?php echo form_open('sub_admin/user_options_post'); ?>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                         <?php if(is_admin() || is_permission_user('sub_admin_ban')): ?>
                                            <!--<li>-->
                                            <!--<a class="p0">-->
                                            ...
                                            <?php endif; ?>
                                         <?php if(is_admin() || is_permission_user('sub_admin_edit')): ?>
                                            <li>
                                            <a class="edituser"href="<?php echo base_url(); ?>admin/sub-admin-edit/<?=$user->id;?>">
                                                    <i class="fa fa-edit i-edit"></i>
                                                Edit
                                            </a>
                                            </li>
                                         <?php endif;?>
                                        <?php if(is_admin() || is_permission_user('sub_admin_delete')): ?>
                                            <li>
                                                <a class="p0">
...
<div id="myModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <?php echo form_open('sub_admin/change_user_role_post'); ?>
