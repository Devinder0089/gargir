            ...
            <div class="row contentrow">
                ...
                <div class="row formcontentrow">
                        <div class="col-sm-12 loginbox">    
                                ...
                                <!-- form start -->
                                <?php echo form_open_multipart('customer/addProperty_post'); ?>
                                ...
                                <?php $this->load->view('partials/_messages'); ?>
                                 ...
                                 <div class="col-sm-12 fullsec">
                                    ...
                                    <div class="col-sm-3 secimput">
                                        ...
                                        <div class="form-group has-feedback">
                                        <input type="text" class="form-control form-input" name="buil_number" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-3 secimput">
                                ...
                                <div class="col-sm-12 fullsec">
                                    ...
                                    <div class="col-sm-3 secimput">
                                        ...
                                        <div class="form-group has-feedback">
                                        <input type="text" class="form-control form-input" name="floor">
