...
<div class="box">
    <div class="box-header">
        <div class="left">
            ...
            <div class="right">
            <a href="<?php echo base_url('admin');?>/add-customer" class="btn btn-sm btn-success btn-add-new">
                        ...
                        if(isset($customer)):
                         foreach ($customer as $user): ?>
                            <tr>
                                ...
                                <td>
                                    <!-- form delete user -->
                                    <?php echo form_open('customer/user_options_post'); ?>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                          <?php if(is_admin() || is_permission_user('customer_role')): ?>
                                              <li>
                                                <a class="p0">
                                        ...
                                        <?php endif; ?>
                                         ...
                                         <?php if(is_admin() || is_permission_user('customer_ban')): ?>
                                         ...
                                         <?php  if($user->status == "1"): ?>
                                            ...
                                            <?php endif; ?>
                                                 ...
                                                 <?php endif; ?>
                            <?php if(is_admin() || is_permission_user('customer_view')): ?>
                                            <li>
                                                <a class="edituser"href="<?php echo base_url(); ?>admin/user-details/<?=$user->id;?>">
                                                    <i class="fa fa-eye i-view"></i>
                                                view
                                            </a>
                                            </li>
                                <?php endif;?>
                                     <?php if(is_admin() || is_permission_user('customer_edit')): ?>
                                            <li>
                                     ...
                                     <?php if(is_admin() || is_permission_user('customer_delete')): ?>
                                            <li>
                                                <a class="p0">
...
<div id="myModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <?php echo form_open('customer/change_user_role_post'); ?>
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-sm-3 titlerol">
                        <input type="radio" name="role" value="sub-admin" id="role_user" class="square-purple" required>
                        <label for="role_user" class="option-label">sub admin</label>
                        </div>
                    </div>
                </div>
