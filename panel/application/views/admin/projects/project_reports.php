            ...
            <div class="col-sm-12">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped dataTable" id="cs_datatable" role="grid"
                        ...
                        <?php foreach ($project_reports as $item): ?>
                            <tr>
                                <td><?=$item->id;?></td>
                               ...
                               <td class="break-word"><?=$item->user;?></td>
                                ...
                                <td>
                                    ...
                                    <?php echo form_open('projects/delete_project_report_post'); ?>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <li>
                                            <a class="edituser"href="<?php echo base_url(); ?>admin/project/report/<?=$item->id;?>">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" id="addForm" action="<?php echo base_url('projects/projectReports_post')?>" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label for="recipient-name" class="col-form-label"><?=trans('files');?>:</label>
...
<script>
    $(document).ready(function(){
        ...
        $('.getDetails').on('click', function(){
            ...
            $.ajax({
                type: "POST",
                url: base_url + 'projects/getDetails',
                data:{id:id},
