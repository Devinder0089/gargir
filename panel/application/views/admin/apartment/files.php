                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($item->files == ""):?>
                                        <p><?=trans('no_file')?></p>
                                    <?php else:?>
                                        <a class="edituser" target="_blank" href="<?php echo base_url(); ?>uploads/project/apartment/files/<?=$item->files;?>">
                                ...
                                <td><?= date('Y-m-d', strtotime($item->created_at));?></td>
                                 <td>
                                     ...
                                     <?php if($item->status == 1):?>
                                        <button class="label label-primary"><?=trans('approved')?></button>
                                    <?php elseif($item->status == 0):?>
                                        <button class="label label-danger"><?=trans('not_approved')?></button>
                                     <?php endif;?>
                               ...
                               <td>
                                    ...
                                    <?php echo form_open('apartment/delete_apartment_file'); ?>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form method="post" id="addForm" action="<?php echo base_url('apartment/files_post')?>" enctype="multipart/form-data">
