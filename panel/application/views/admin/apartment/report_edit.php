    ...
    <div class="col-sm-12">
        <div class="box box-primary">
            ...
            <div class="box-header">
                ...
                <div class="right">
                    <a href="<?php echo base_url(); ?>admin/project/apartment-reports/<?=$report->apart_slug;?>" class="btn btn-sm btn-success btn-add-new">
                        <i class="fa fa-bars"></i>
                        <?=trans('apartment_reports');?>
                    </a>
                </div>
            </div><!-- /.box-header -->

            <!-- form start -->
            <form method="post" id="updateForm" enctype="multipart/form-data" action="<?php echo base_url('apartment/apartmentReportEdit_post')?>">

            <div class="box-body">
                <!-- include message block -->
                <?php $this->load->view('admin/includes/_messages'); ?>
                <input type="hidden" name="id" value="<?= $report->id ?>"/>
                 <input type="hidden" name="apartment_id" value="<?= $report->apartment_id ?>"/>
                    ...
                    <div class="row">
                        <div class="col-sm-12" style="text-align:right">
                             <?php 
                                ...
                                ?>
                                   <a class="edituser" target="_blank" href="<?php echo base_url(); ?>uploads/project/apartment/<?=$img;?>">
                                        <i class="fa fa-book i-edit"><?=trans('click_to_view');?></i>
                                    </a>
                                <?php else:?>
                                 <a class="edituser" target="_blank" href="<?php echo base_url(); ?>uploads/project/apartment/<?=$img;?>">
                                         <img width="200px" height="200px" src="<?= base_url();?>uploads/project/apartment/<?= $img ?>"/>
                                    </a>
            ...
            <button type="submit" name="projectbt" class="btn btn-primary btn-block pull-right update"><?=trans('update');?></button>
            </div>
            <!-- /.box-footer -->
            </form><!-- form end -->
