    ...
    <div class="col-md-12">
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li class=""><a href="#tab_2" data-toggle="tab" aria-expanded="false"><?= trans('email_settings') ?></a></li>
            ...
            <div class="tab-content settings-tab-content">
                ...
                <div class="tab-pane active" id="tab_1">
                    ...
                    <div class="col-sm-12 col-xs-12 form-group aboutsec">
                ...
                <div class="tab-pane" id="tab_2">
                    ...
                    <div class="form-group">
                        ...
                        <select name="mail_protocol" class="form-control custom-select">
                            <option value="tls" <?php echo ($settings->mail_protocol == "tls") ? "selected" : ""; ?>><?= trans('tls') ?></option>
                            <option value="smtp" <?php echo ($settings->mail_protocol == "smtp") ? "selected" : ""; ?>><?= trans('smtp') ?></option>
                            <option value="mail" <?php echo ($settings->mail_protocol == "mail") ? "selected" : ""; ?>><?= trans('mail') ?></option>
                        </select>
                    </div>
                    ...
                    <div class="callout" style="max-width: 500px;margin-top: 30px;">
                        ...
                        <p><strong><?= trans('mail_host') ?>:&nbsp;&nbsp;</strong>ssl://smtp.googlemail.com</p>
                        <p><strong><?= trans('mail_port') ?>:&nbsp;&nbsp;</strong>465</p>
                    </div>
                ...
                <div class="tab-pane" id="tab_3">
                  ...
                  <!--   <div class="form-group">
                    ...
                    <div class="col-sm-12 col-md-12 form-group seccontacttext">
                        <label class="control-label"><?= trans('contact_text') ?></label>
                        <textarea class="form-control" name="contact_text"
                ...
                <div class="tab-pane" id="tab_4">
                    <div class="form-group">
                        <label class="control-label"><?= trans('whatsapp_number') ?></label>
                        <input type="text" class="form-control" name="whatsapp_number"
                               placeholder="WhatsApp Number" value="<?php echo html_escape($settings->whatsapp_number); ?>">
                    </div>
                    <div class="form-group">
                        <label class="control-label"><?= trans('whatsapp_text') ?></label>
                        <input type="text" class="form-control" name="whatsapp_text"
                               placeholder="WhatsApp Text" value="<?php echo html_escape($settings->whatsapp_text); ?>">
                    </div>
                    ...
                    <div class="form-group">
                        <label class="control-label"><?= trans('twiiter_url') ?></label>
                    ...
                    <div class="form-group">
                        <label class="control-label"><?= trans('google_url') ?></label>
                        <input type="text" class="form-control"
