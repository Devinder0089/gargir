...
<div class="box">
    <div class="box-header">
        ...
        <div class="right">
                <a href="<?php echo base_url('admin');?>/add-worker" class="btn btn-sm btn-success btn-add-new">
                        ...
                        <?php foreach ($users as $user): ?>
                            <tr>
                                ...
                                <label class="label label-primary">
                                 ...
                                 <td>
                                    <a class="edituser"href="<?php echo base_url(); ?>admin/worker-assigned-projects/<?=$user->slug;?>">
                                ...
                                <td>
                                    <!-- form delete user -->
                                    <?php echo form_open('workers/user_options_post'); ?>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                                ...
                                                <li>
                                                <a class="edituser"href="<?php echo base_url(); ?>admin/worker-details/<?=$user->slug;?>">
                                                        <i class="fa fa-file i-edit"></i>
                                                    <?= trans('user_details');?>
                                                </a>
                                                </li>
                                            ...
                                            <a class="edituser"href="<?php echo base_url();?>admin/worker-edit/<?php echo $user->slug ?>">
