...
<div class="row rowvisualsettings">
        ...
        <div class="box box-primary">
            <div class="box-header">
                <div class="left">
                    ...
                    <br>
                    <small>You can change your <?= $title ?> from this form</small>
                </div>
            </div><!-- /.box-header -->
 ...
 -->
    ...
    <div class="row">
        ...
        <img src="<?php echo get_logo($visual_settings); ?>" style="width: 100px; height: 50px">
        </div>
        <div class="col-sm-12 form-group">
        <a class='btn btn-success btn-sm'>
        <?= trans('change_logo') ?>
        <input type="file" name="logo" size="40" class="uploadFile"                    accept=".png, .jpg, .jpeg, .gif"
    ...
    <div class="row">
        ...
        <img src="<?php echo get_logo_footer($visual_settings); ?>" style="width:100px; height: 50px">
        </div>
        
        <div class="col-sm-12 form-group">
        <a class='btn btn-success btn-sm'>
        <?= trans('change_footer_logo') ?>
    ...
    <div class="row">
        <div class="col-sm-12 form-group">
        <label class="control-label"><?= trans('favicon') ?></label>
        <img src="<?php echo get_favicon($visual_settings); ?>" style="width: 20px; height: 20px">
        </div>
