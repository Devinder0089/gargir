...
class Settings_model extends CI_Model
{
    ...
    public function input_values(){
        $whatsapp_number=($this->input->post('whatsapp_number'))?$this->input->post('whatsapp_number'):'+910000000000';
        $whatsapp_text=($this->input->post('whatsapp_text'))?$this->input->post('whatsapp_text'):'hi...';
        $data = array(
