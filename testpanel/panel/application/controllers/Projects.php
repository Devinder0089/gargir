...
class Projects extends MY_Controller
{
    ...
    public function add_project_post(){
        ...
        if(empty($title)){
            $this->session->set_flashdata('error','Please enter title.');
            redirect($this->agent->referrer());
        }

        
        if(empty($currency)){
            $this->session->set_flashdata('error','Please enter currency.');
            redirect($this->agent->referrer());
        }
        
    if(empty($type)){
            $this->session->set_flashdata('error','Please enter type.');
            redirect($this->agent->referrer());
        }
    ...
    */
    public function project_details($id){
        ...
        $data['projects'] = $this->project_model->project_details($id);
    ...
    public function delete_project_post(){
        ...
        if($this->project_model->delete_project($id)) {
            $this->session->set_flashdata('success', "projects successfully deleted!");
            redirect($this->agent->referrer());
        } else {
            $this->session->set_flashdata('error', "There was a problem deleting the projects!");
            redirect($this->agent->referrer());
        }
